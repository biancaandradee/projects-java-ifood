...
public class Chefe extends Funcionario {
	...
	public Chefe(int num, String nome, double salarioBase, double adicionalFuncao, double beneficioTerno) {
		super(num, nome);
	...
	public String toString() {
		return "Chefe [num=" + num + ", nome=" + nome + ", salarioBase=" + salarioBase
